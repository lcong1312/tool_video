from src.schemas.build_draft import BuildDraftRequest, BuildDraftResponse, BuildDraftData
...
@router.post(path="/build_draft", response_model=BuildDraftResponse)
def build_draft_endpoint(req: BuildDraftRequest) -> BuildDraftResponse:
    """Build a CapCut draft in-memory from local media paths (Auto Capcut Pro)."""
    draft_content, draft_meta_info = service.build_draft(req)
    return BuildDraftResponse(
        data=BuildDraftData(draft_content=draft_content, draft_meta_info=draft_meta_info)
    )
